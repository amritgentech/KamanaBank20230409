...
namespace DbOperations
{
    public class Parameter
    {
        ...
        public Parameter(string name, object value, ParameterDirection paramDirection)
        {
            _name = name;
            _value = value;
        ...
        /// <param name="dbType">Data type</param>
        /// <param name="paramDirection">Parameter direction</param>
        public Parameter(string name, object value, DbType dbType, ParameterDirection paramDirection)
        {
            _name = name;
            _value = value;
            _type = dbType;
