...
namespace ReconParser.App_Code.Recon.Visa.EP727
{
    public class EP727Visa : Visa
    {
        public EP727Visa(String FileName, int FileCount)
            : base(FileName, FileCount)
        {
            _SubSource = SubSource.Find_By_Name("EP727");
        }
                ...
                try
                {
                    if (_TransactionBlock.TransactionBlockList.Count >= 13)
                    {
                        ...
                        if (isRequiredData)
                        {
                            ...
                            _TransactionStatus = TransactionStatus.Reversal;  // default reversal..ep 727
