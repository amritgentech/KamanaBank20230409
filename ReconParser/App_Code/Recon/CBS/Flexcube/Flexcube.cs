...
namespace ReconParser.App_Code.Recon.CBS.Flexcube
{
    public class Flexcube : Cbs
    {
        public Flexcube(String FileName, int FileCount)
            : base(FileName, FileCount)
        {
            _SubSource = SubSource.Find_By_Name("Flexcube");
        }
        ...
        public void ReadDataFromFile(string FileName)
        {
            ...
            {
                Console.Write("Erro->Flexcube->ReadDataFromFile->" + ex.Message);
            }
        }
        ...
        protected Transaction GetTransation(DataRow _dataRow)
        {
            try
            {
               ...
               double d = double.Parse(_dataRow[7].ToString());
                ...
                _Transaction.TransactionDate = conv;
